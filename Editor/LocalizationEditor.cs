    ...
    public class LocalizationEditor : EditorWindow {
        ...
        private void OnGUI() {
            ...
            localizationData = (LocalizationData)EditorGUILayout.ObjectField(
                "Localization Data", localizationData, typeof(LocalizationData), false);
        ...
        private void ShowEntriesList() {
            ...
            var filteredEntries = localizationData.entries
                .Where(e => string.IsNullOrEmpty(searchFilter) || e.key.ToLower().Contains(searchFilter.ToLower()) ||
                            e.ru.ToLower().Contains(searchFilter.ToLower()) || e.en.ToLower().Contains(searchFilter.ToLower()))
                .Where(e => !showOnlyMissing || string.IsNullOrEmpty(e.ru) || string.IsNullOrEmpty(e.en)).ToList();
            ...
            for (int i = 0; i < filteredEntries.Count; i++) {
                ...
                if (GUILayout.Button("Delete", GUILayout.Width(60))) {
                    if (EditorUtility.DisplayDialog("Confirm Delete", $"Are you sure you want to delete the entry '{entry.key}'?", "Delete",
                            "Cancel")) {
